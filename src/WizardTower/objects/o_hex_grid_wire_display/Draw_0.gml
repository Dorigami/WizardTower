...
draw_self();
shader_reset();
var _listsize = is_undefined(global.i_hex_grid.mouse_hex_index) ? -1 : ds_list_size(global.i_hex_grid.hexarr_containers[global.i_hex_grid.hex_get_index(grid_id.mouse_hex_coord)]);
