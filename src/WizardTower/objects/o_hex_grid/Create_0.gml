...
uresW = shader_get_uniform(sWireHex, "resW");
uresH = shader_get_uniform(sWireHex, "resH");
wire_width = sprite_get_width(sWireHex);
wire_height = sprite_get_height(sWireHex);
